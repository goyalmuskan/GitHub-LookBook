    ...
    fetch("https://api.github.com/users/" + username + "/repos?per_page=150", {
        ...
        .then((result) => {
            ...
            if (repo.length == 0) {
                ...
                var repoList = '<center><div class="row"><div class="col-lg-3 image-div"><img class="pt-4 mt-5 pb-2 mx-3" src="' + repo[0].owner.avatar_url + '" width="250px" style="border-radius:50%"><br><br><p><a href="'+repo[0].owner.html_url + repo[0].owner.followers +'" class="link">@'+ repo[0].owner.login +'</p></div><div class="col-lg-9"><br><h5 class ="mt-4" style="color:white;">Their Awesome Work</h5><div class="card-columns py-4 mt-4 px-4">';
